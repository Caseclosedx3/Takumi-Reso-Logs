...
<div class="space-y-6">
  <div class="flex items-center justify-between">
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-xl font-bold text-foreground">Real-Time Monitor</h1>
        <p class="text-sm text-muted-foreground">Customise skill CD, combat resource monitoring, and more</p>
      </div>
    </div>
